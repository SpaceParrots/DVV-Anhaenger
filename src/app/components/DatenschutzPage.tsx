        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="bg-white rounded-[24px] p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#F1F5F9]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-[18px] font-black text-black mb-3">1. Verantwortliche Stelle</h3>
          ...
          <div className="bg-white rounded-[24px] p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#F1F5F9]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-[18px] font-black text-black mb-3">2. Erhebung und Speicherung personenbezogener Daten</h3>
          ...
          <div className="bg-white rounded-[24px] p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#F1F5F9]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-[18px] font-black text-black mb-3">3. Weitergabe von Daten</h3>
                <div className="text-[12px] text-[#64748B] leading-relaxed space-y-3">
          ...
          <div className="bg-white rounded-[24px] p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#F1F5F9]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-[18px] font-black text-black mb-3">4. Speicherdauer</h3>
                <div className="text-[12px] text-[#64748B] leading-relaxed space-y-2">
          ...
          <div className="bg-white rounded-[24px] p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#F1F5F9]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-[18px] font-black text-black mb-3">5. Ihre Rechte</h3>
                <div className="text-[12px] text-[#64748B] leading-relaxed space-y-2">
          ...
          <div className="bg-white rounded-[24px] p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#F1F5F9]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-[18px] font-black text-black mb-3">6. Cookies und Tracking</h3>
                <div className="text-[12px] text-[#64748B] leading-relaxed space-y-2">
          ...
          <div className="bg-white rounded-[24px] p-5 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] border border-[#F1F5F9]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-[18px] font-black text-black mb-3">7. Datensicherheit</h3>
