...
function FAQItem({ question, answer }: FAQItemProps) {
  ...
  return (
    <div className="border-b border-[#E2E8F0] last:border-0">
      ...
      >
        <span className="text-[14px] font-bold text-dark">{question}</span>
...
export function Footer({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  return (
    <footer className="bg-white border-t border-[#E2E8F0] pt-12 pb-24 px-5">
      <div className="max-w-4xl mx-auto">
        {/* FAQ Section */}
        <div className="mb-12">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-1.5 h-6 bg-primary rounded-full" />
            <h3 className="text-[16px] font-black uppercase tracking-wider text-dark">Häufige Fragen (FAQ)</h3>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-10">
          <button 
            ...
            className="flex flex-col items-start p-4 bg-white border border-[#E2E8F0] rounded-xl hover:border-primary/30 transition-all group"
          >
            <Scale className="w-5 h-5 text-slate-400 group-hover:text-primary mb-3" />
            <p className="text-[13px] font-bold text-dark leading-none mb-1">Impressum</p>
          ...
          >
            ...
            <p className="text-[13px] font-bold text-dark leading-none mb-1">Datenschutz</p>
          ...
          >
            <Scale className="w-5 h-5 text-slate-400 group-hover:text-primary mb-3" />
            <p className="text-[13px] font-bold text-dark leading-none mb-1">AGB</p>
          ...
          >
            ...
            <p className="text-[13px] font-bold text-dark leading-none mb-1">Widerruf</p>
