  ...
  return (
    <div className="px-5 mb-8">
      <div className="text-center mb-8">
        <h2 className="text-[10px] font-black tracking-widest uppercase text-slate-400 mb-1">
          IN 5 SCHRITTEN ZUM ANHÄNGER
        </h2>
      </div>

      <div className="relative">
        <div className="absolute top-5 left-10 right-10 h-px bg-slate-200 border-t border-dashed border-gray-200" />
